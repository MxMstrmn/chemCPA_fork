...
Or downlaod it using pertpy
"""
#import pertpy as pt
#adata = pt.data.replogle_2022_k562_essential()

adata=sc.read_h5ad(f"{load_path}/K562_essential_raw_singlecell_01.h5ad")
...
adata.obs['treatment_time_h']=6*24.0
adata.obs['treatment_type']='gene_knockout'
adata.obs['dataset']='Replogle_K562'
